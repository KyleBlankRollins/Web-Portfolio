<template>
  <footer class="font-body">
    ...
    >
      <div class="flex justify-center items-center w-auto py-2">
        ...
        <div class="w-1/4 flex justify-end">
          <div class="w-12 px-2">
            <a href="https://github.com/KyleBlankRollins" class="text-secondary">
              <svg
                version="1.1"
                viewBox="0 0 448 512"
                xmlns="http://www.w3.org/2000/svg"
                class="fill-current hover:text-callout hover:fill-current"
              >
                <path
          ...
          <div class="w-12 px-2">
            <a href="https://twitter.com/KyleBRollins" class="text-secondary">
              <svg
                version="1.1"
                viewBox="0 0 448 512"
                xmlns="http://www.w3.org/2000/svg"
