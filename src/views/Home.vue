      ...
      <section class="flex mt-12 pb-6">
        <div class="w-3/4 bg-primary rounded shadow-lg">
          ...
          <div class="px-6 py-2">
            ...
            <p>
              I then built the main part of KyleBlankRollins.com with VuePress,
              a static site generator that leverages Vue.js. While I like
              VuePress, I felt it was overkill for a site like this with little
              text content.
            </p>
            <p>
              So, I re-built with Vue.js and Tailwind CSS. While this is still
              likely overkill for now, I have plans for the site that will make
              more use of the tools Vue.js offers.
            </p>
            <p>
              Subdomains are built with other tools and are often experiments.
              For example, TheCanneyValley is built with Gridsome, a static site
              generator.
            </p>
          </div>
        </div>
        <div class="w-1/4 flex flex-col items-center text-primary mx-2 mr-10">
          ...
          <a
            ...
            class="flex flex-col items-center mb-6 text-primary hover:text-accent"
          >
            <svg
          ...
          <a
            href="https://www.linkedin.com/in/kyle-blank-rollins/"
            class="flex flex-col items-center mb-6 text-primary hover:text-accent"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href="https://twitter.com/KyleBRollins"
            class="flex flex-col items-center mb-6 text-primary hover:text-accent"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
